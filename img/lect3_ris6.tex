...
% \pgfplotstableread{data.tsv}\mytable 
    ...
    interface/.style={
		...
		\begin{axis}[
			...
			extra x ticks={1,5, 6, 7.5,9,11.5},	% положение дополнительных тиков
			extra x tick labels={	% их подписи
			 		{$0$},{\textcolor{green!30!black}{$\varkappa_1$}},{$$},{\textcolor{red}{$\varkappa_2$}},{\textcolor{red}{$\varkappa_3$}},{\textcolor{red}{$\varkappa_4$}},
			}, 		
		]

		\draw (6,0) node[above]  (k) {$k$};

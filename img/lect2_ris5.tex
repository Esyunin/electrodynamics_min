...
\begin{tikzpicture}[z={(1cm,0cm)}, y={(-0.4cm,-0cm)}, x={(0cm,1cm)}, scale=1,
    ...
    \begin{scope}[canvas is yx plane at z=4]
        \draw[fill=magenta!20] (0,0,0) circle (1.2cm)  node[right, yshift=.8cm, xshift=.45cm] {$L$};
    ...
    \draw[fill=magenta!20,draw=none] (-1.2,-1.2,-.5) rectangle (1.2,1.2,4.5);
    ...
    \begin{scope}[canvas is yx plane at z=0]
        \draw[fill=white] (0,0,0) node[sloped] {$S_1$} circle (1.2cm) node[right, yshift=.8cm, xshift=.45cm] {$L$};
        % \draw[fill=white] (0,0,0) circle (1cm);
    \end{scope}
        \begin{scope}[canvas is yx plane at z=4]
        % \draw[dashed] (0,0,0) circle (1cm);
        \draw[dashed] (0,0,0) node[sloped] {$S_2$} circle (1.2cm);
        % \draw[fill=white] (0,0,0) circle (1cm);
    \end{scope}

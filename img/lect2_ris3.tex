...
\begin{document}
\begin{tikzpicture}[z={(1cm,0cm)}, y={(-0cm,-0.4cm)}, x={(0cm,1cm)}, scale=1,
    ...
    \begin{scope}[canvas is yz plane at x=0]
        \draw[fill=black!5] (0,0) circle (1.2cm) node[sloped] {$S_\perp$} (0,1.4)  node [right] {$L$};
        \draw (1.5,0) node[below] {Закрепленная граница};
    \end{scope}

    \begin{scope}[, xshift=5cm,]
     \begin{scope}[canvas is yz plane at x=0]
        \draw[fill=black!5] (0,0) circle (1.2cm) node[sloped] {$S_\perp$} (0,1.4)  node [right] {$L$};
        \draw (1.5,0) node[below] {Свободная граница};
     \end{scope}       
        \draw[<->] (0,0.5,0)++(xyz spherical cs: radius=1.2, angle=0,latitude=0) -- ++(0,-1,0);
        \draw[<->] (0,0.5,0)++(xyz spherical cs: radius=1.2, angle=0,latitude=90) -- ++(0,-1,0);
        \draw[<->] (0,0.5,0)++(xyz spherical cs: radius=1.2, angle=0,latitude=180) -- ++(0,-1,0);
        \draw[<->] (0,0.5,0)++(xyz spherical cs: radius=1.2, angle=0,latitude=270) -- ++(0,-1,0);
    \end{scope}
